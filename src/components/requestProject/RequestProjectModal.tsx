...
export default function RequestProjectModal({ open, onClose, prefillService }: Props) {
  return (
    <AnimatePresence>
      {open && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <RequestProjectForm variant="modal" prefillService={prefillService} onSuccess={onClose} />
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
